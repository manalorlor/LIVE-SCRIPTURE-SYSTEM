...
export const LoginPage: React.FC<LoginPageProps> = ({ onLoginSuccess }) => {
  ...
  return (
    <div className="min-h-screen bg-slate-950 flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md bg-slate-900/80 backdrop-blur-xl p-8 rounded-2xl border border-slate-800 shadow-2xl relative z-10">
        ...
        <div className="text-center mb-8">
            ...
            <h1 className="font-heading text-2xl font-bold text-slate-100 tracking-wider">SCRIPTURE LIVE</h1>
        ...
        <form onSubmit={handleFinalSubmit} className="space-y-6 animate-in fade-in slide-in-from-bottom-4">
             <div className="text-center">
                <p className="text-slate-400 text-sm mb-4">Enter the name of your organization to begin.</p>
             </div>
             ...
             <div>
                ...
                <input 
                    ...
                    className="w-full bg-slate-950/50 border border-slate-700 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-amber-500 transition-colors"
                    autoFocus
                    required
                />
             </div>
